...
Status:       v0.4 (2026-09-26) — design REVIEWED (Ömer, PR #7); RTL IMPLEMENTED, simulated, synthesised
...
|---|---|---|---|
| TB-BTN-01 | `fpga/tb/debug/tb_button_conditioner.vhd` | clean press → exactly 1 pulse, 1 clock wide, after 2 + D rising edges | IF-002 |
...
| SYN-TOPDBG | `fpga/vivado/build_debug_demo.tcl` | synthesis + implementation + bitstream, timing met at 100 MHz, no critical warnings, DRC clean | REQ-VER-001 |
...
### 17.1 Results (2026-09-26, Vivado 2025.2)

| Test | Result | Evidence |
|---|---|---|
| TB-BTN-01…05 | PASS 22/22; 3 injected bugs detected | `simulation/results/2026-09-26_tb_button_conditioner.log` |
| TB-TOPDBG-01…03 | PASS 15/15 (2 full frames, 131 088 bytes = COE); latency mutant detected | `simulation/results/2026-09-26_tb_top_debug_demo.log` |
| SYN-TOPDBG | bitstream written; WNS +5.083 ns, WHS +0.122 ns; DRC 0; 128 LUT, 114 FF, 14.5 BRAM | `docs/verification/2026-09-26_top_debug_demo_*.rpt` |
| HW-DEBUG-01…05 | open | — |

Build note: Vivado cannot open sources under a path with non-ASCII characters or spaces
(`…\OneDrive\Masaüstü\EEE391 Project\…`); build and simulate from a clone at an ASCII path (DEC-014).
...
| 0.3 | 2026-09-26 | Eren (AI-0010) | RTL implemented; exact button latency (2 + D edges); post-route numbers (BRAM 14.5 tiles, not 16); results §17.1; build script renamed `build_debug_demo.tcl` (non-project flow) |
