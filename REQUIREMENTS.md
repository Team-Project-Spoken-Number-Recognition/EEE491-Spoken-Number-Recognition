...
| REQ-HW-002 | FPGA pin assignment shall come from Digilent's `Basys3_Master.xdc`, with port names renamed to the top-level names. | Correct pinning | DBG §3 | I, H | OPEN | Eren |
